module @processor {
  ...
  func.func @dram_to_l1_R_f16(%src: memref<?x?xf16>, %dst: memref<?x?xf16>) {
    ...
    loom.bind_mem %src, @input_0 : memref<?x?xf16>
    loom.bind_mem %dst, @output_0 : memref<?x?xf16>
    loom.copy %src, %dst src_mem_space @input_0 dst_mem_space @output_0 : 1, area: [1, 1] : memref<?x?xf16> to memref<?x?xf16>
    return
  }
  func.func @dram_to_l1_R_bcst(%src: memref<?x?xf16>, %dst: memref<?x?xf16>) {
    ...
    loom.bind_mem %src, @input_0 : memref<?x?xf16>
    loom.bind_mem %dst, @output_0 : memref<?x?xf16>
    loom.copy %src, %dst src_mem_space @input_0 dst_mem_space @output_0 : 1, area: [%bcst_x, %bcst_y] : memref<?x?xf16> to memref<?x?xf16>
    return
  }
}
