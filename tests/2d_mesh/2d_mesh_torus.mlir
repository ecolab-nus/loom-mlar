module @arch_system {
  ...
  %7 = adl.memory.array "mem_L1_instance", [%6] of %5
  %8 = adl.memory.array "mem_L1", [%1, %2] of %7
  ...
  module @proc_matrix_lane {
    func.func @matmul_SS_f16(%A: memref<?x?xf16>, %B: memref<?x?xf16>, %C: memref<?x?xf16>) {
      ...
      loom.bind_mem %A, @mem_L1_instance : memref<?x?xf16>
      loom.bind_mem %B, @mem_L1_instance : memref<?x?xf16>
      loom.bind_mem %C, @mem_L1_instance : memref<?x?xf16>
    ...
    func.func @matmul_SR_f16(%A: memref<?x?xf16>, %B: memref<?x?xf16, 1>, %C: memref<?x?xf16>) {
      ...
      loom.bind_shape %C, [%M, %N] : memref<?x?xf16>
      loom.bind_mem %A, @mem_L1_instance : memref<?x?xf16>
      loom.bind_mem %B, @mem_L1_instance : memref<?x?xf16, 1>
      loom.bind_mem %C, @mem_L1_instance : memref<?x?xf16>
    ...
    func.func @matmul_RS_f16(%A: memref<?x?xf16, 1>, %B: memref<?x?xf16>, %C: memref<?x?xf16>) {
      ...
      loom.bind_shape %B, [%K, %N] : memref<?x?xf16>
      loom.bind_shape %C, [%M, %N] : memref<?x?xf16>
      loom.bind_mem %A, @mem_L1_instance : memref<?x?xf16, 1>
      loom.bind_mem %B, @mem_L1_instance : memref<?x?xf16>
      loom.bind_mem %C, @mem_L1_instance : memref<?x?xf16>
    ...
    func.func @batch_matmul_SS_f16(%A: memref<?x?x?xf16>, %Bmat: memref<?x?x?xf16>, %C: memref<?x?x?xf16>) {
      ...
      loom.bind_mem %A, @mem_L1_instance : memref<?x?x?xf16>
      loom.bind_mem %Bmat, @mem_L1_instance : memref<?x?x?xf16>
      loom.bind_mem %C, @mem_L1_instance : memref<?x?x?xf16>
    ...
    func.func @batch_matmul_SR_f16(%A: memref<?x?x?xf16>, %Bmat: memref<?x?x?xf16, 1>, %C: memref<?x?x?xf16>) {
      ...
      loom.bind_shape %C, [%B, %M, %N] : memref<?x?x?xf16>
      loom.bind_mem %A, @mem_L1_instance : memref<?x?x?xf16>
      loom.bind_mem %Bmat, @mem_L1_instance : memref<?x?x?xf16, 1>
      loom.bind_mem %C, @mem_L1_instance : memref<?x?x?xf16>
    ...
    func.func @batch_matmul_RS_f16(%A: memref<?x?x?xf16, 1>, %Bmat: memref<?x?x?xf16>, %C: memref<?x?x?xf16>) {
      ...
      loom.bind_shape %Bmat, [%B, %K, %N] : memref<?x?x?xf16>
      loom.bind_shape %C, [%B, %M, %N] : memref<?x?x?xf16>
      loom.bind_mem %A, @mem_L1_instance : memref<?x?x?xf16, 1>
      loom.bind_mem %Bmat, @mem_L1_instance : memref<?x?x?xf16>
      loom.bind_mem %C, @mem_L1_instance : memref<?x?x?xf16>
    ...
    func.func @vec_vsum_f16(%a: memref<?x?xf16>, %out: memref<?xf16>) {
      ...
      loom.bind_mem %a, @mem_L1_instance : memref<?x?xf16>
      loom.bind_mem %out, @mem_L1_instance : memref<?xf16>
      linalg.generic {
      indexing_maps = [
    ...
    func.func @vec_max1_f16(%a: memref<?xf16>, %b: memref<?xf16>, %out: memref<?xf16>) {
      ...
      loom.bind_mem %a, @mem_L1_instance : memref<?xf16>
      loom.bind_mem %b, @mem_L1_instance : memref<?xf16>
      loom.bind_mem %out, @mem_L1_instance : memref<?xf16>
      linalg.generic {
      indexing_maps = [
      affine_map<(d0) -> (d0)>,
    ...
    func.func @elementwise_add_f16(%a: memref<?x?xf16>, %b: memref<?x?xf16>, %out: memref<?x?xf16>) {
      ...
      loom.bind_mem %a, @mem_L1_instance : memref<?x?xf16>
      loom.bind_mem %b, @mem_L1_instance : memref<?x?xf16>
      loom.bind_mem %out, @mem_L1_instance : memref<?x?xf16>
  ...
  module @proc_vector_lane {
    ...
    func.func @vec_sum_f16(%a: memref<?xf16>, %init: memref<f16>) {
      ...
      loom.bind_shape %a, [%L] : memref<?xf16>
      loom.bind_mem %a, @mem_L1_instance : memref<?xf16>
      loom.bind_mem %init, @mem_L1_instance : memref<f16>
      linalg.generic {
      indexing_maps = [
      affine_map<(d0) -> (d0)>,
      affine_map<(d0) -> ()>
    ...
    func.func @vec_cmpf_ogt_f16(%a: memref<?xf16>, %b: memref<?xf16>, %out: memref<?xi1>) {
      ...
      loom.bind_mem %a, @mem_L1_instance : memref<?xf16>
      loom.bind_mem %b, @mem_L1_instance : memref<?xf16>
      loom.bind_mem %out, @mem_L1_instance : memref<?xi1>
      linalg.generic {
      indexing_maps = [
      affine_map<(d0) -> (d0)>,
      affine_map<(d0) -> (d0)>,
    ...
    func.func @vec_select_f16(%cond: memref<?xi1>, %a: memref<?xf16>, %b: memref<?xf16>, %out: memref<?xf16>) {
      ...
      loom.bind_shape %b, [%L] : memref<?xf16>
      loom.bind_shape %out, [%L] : memref<?xf16>
      loom.bind_mem %cond, @mem_L1_instance : memref<?xi1>
      loom.bind_mem %a, @mem_L1_instance : memref<?xf16>
      loom.bind_mem %b, @mem_L1_instance : memref<?xf16>
      loom.bind_mem %out, @mem_L1_instance : memref<?xf16>
      linalg.generic {
  ...
  module @proc_dram_l1_noc0 {
    func.func @dram_to_l1_S_f16(%dram_src: memref<?x?xf16>, %l1_dst: memref<?x?xf16>) {
      ...
      loom.copy %dram_src, %l1_dst src_mem_space @mem_DRAM dst_mem_space @mem_L1, area: [1, 1] : memref<?x?xf16> to memref<?x?xf16>
      return
    }
    func.func @dram_to_l1_S_bcst(%dram_src: memref<?x?xf16>, %l1_dst: memref<?x?xf16>) {
      ...
      loom.bind_mem %dram_src, @mem_DRAM : memref<?x?xf16>
      loom.bind_mem %l1_dst, @mem_L1 : memref<?x?xf16>
      loom.copy %dram_src, %l1_dst src_mem_space @mem_DRAM dst_mem_space @mem_L1, area: [%bcst_x, %bcst_y] : memref<?x?xf16> to memref<?x?xf16>
      return
    }
    func.func @dram_to_l1_R_f16(%dram_src: memref<?x?xf16>, %l1_dst: memref<?x?xf16>) {
      ...
      loom.bind_mem %dram_src, @mem_DRAM : memref<?x?xf16>
      loom.bind_mem %l1_dst, @mem_L1 : memref<?x?xf16>
      loom.copy %dram_src, %l1_dst src_mem_space @mem_DRAM dst_mem_space @mem_L1 : 1, area: [1, 1] : memref<?x?xf16> to memref<?x?xf16>
      return
    }
    func.func @dram_to_l1_R_bcst(%dram_src: memref<?x?xf16>, %l1_dst: memref<?x?xf16>) {
      ...
      loom.bind_mem %dram_src, @mem_DRAM : memref<?x?xf16>
      loom.bind_mem %l1_dst, @mem_L1 : memref<?x?xf16>
      loom.copy %dram_src, %l1_dst src_mem_space @mem_DRAM dst_mem_space @mem_L1 : 1, area: [%bcst_x, %bcst_y] : memref<?x?xf16> to memref<?x?xf16>
      return
    }
  }
  ...
  module @proc_l1_l1_noc0 {
    func.func @l1_gather(%l1_src: memref<?x?xf16>, %l1_dst: memref<?x?x?xf16>) {
      ...
      loom.bind_mem %l1_dst, @mem_L1 : memref<?x?x?xf16>
      loom.gather %l1_src, %l1_dst src_mem_space @mem_L1 dst_mem_space @mem_L1 area: [%gather_x, %gather_y] : memref<?x?xf16> to memref<?x?x?xf16>
      return
    }
  }
  ...
  module @proc_l1_dram_noc1 {
    func.func @l1_to_dram_f16(%l1_src: memref<?x?xf16>, %dram_dst: memref<?x?xf16>) {
      ...
      loom.copy %l1_src, %dram_dst src_mem_space @mem_L1 dst_mem_space @mem_DRAM, area: [1, 1] : memref<?x?xf16> to memref<?x?xf16>
      return
    }
  }
}
