...
fn test_2d_mesh_torus() {
    ...
    assert_eq!(torus_y_link.region().len(), 1);
    assert_eq!(torus_y_link.region()[0].name(), Some("L1"));
    ...
    assert_eq!(torus_x_link.region().len(), 1);
    assert_eq!(torus_x_link.region()[0].name(), Some("L1"));
